		...
		<div class="container-login100">
			<form class="login100-form validate-form" runat="server" id="Form1">
					...
					<div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
						<asp:TextBox ID="Email" runat="server" class="input100" placeholder="Enter your Username"></asp:TextBox>
					...
					<div class="container-login100-form-btn"> 
						<asp:Button ID="ForgotP" runat="server" class="login100-form-btn" Text="OK" OnClick="ForgotP_Click" />
