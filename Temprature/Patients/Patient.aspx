...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="agil-info-calendar">
        ...
        <div class="col-md-6 agile-calendar">
                        ...
                        <div class="w3l-calendar-left">
                            <div class="calendar-heading">
                                ...
                                <div class="js-gauge--1 text-center ">
                                    ...
                                    <br />
                                    <br />
                                    <p style="font-size:50px; font-style :oblique" id="temperature">00.00 </p>
            ...
            <asp:Label ID="Label1" runat="server" Text="Label" Font-Size="25"></asp:Label>
        </div>
        <div class="col-md-6 agile-calendar">
            <div class="calendar-widget">
                <div class="panel-heading ui-sortable-handle">
                    ...
                    <div class="page">
                        ...
                        <div class="w3l-calendar-left">
                            <div class="calendar-heading">
                                ...
                                <div class="js-gauge--2 text-center ">
                                    <%--js-gauge  gauge--%>
                                    <br />
                                    <br />
                                    <p style="font-size:50px; font-style :oblique" id="pulseRate">00.00 </p>
    ...
    <script>
        ...
        $('.js-gauge--2').kumaGauge({
            value: humid1/*Math.floor((Math.random() * 99) + 1)*/
        });
        ...
        var update = setInterval(function () {
            var newVal = humid1/*Math.floor((Math.random() * 99) + 1)*/;
            $('.js-gauge--2').kumaGauge('update', {
                value: newVal
            });
        }, 1000);
