<%@ Page Title="" Language="C#" MasterPageFile="~/Patients/PatientMasterPage.master" AutoEventWireup="true" CodeFile="About.aspx.cs" Inherits="Patients_Default" %>
                            ...
                            <div class="wrap">
                                <div class="profile-main" style="width: 75%">
                                    ...
                                    <div class="w3-message">
                                        ...
                                        <br />
                                        <br />
                                        <asp:Button ID="Button1" CssClass="fc-button-content" runat="server" Text="About Doctor" Font-Size="20px" OnClick="Button1_Click" />
